...
export function SignInPage() {
  ...
  return (
    <AuthLayout title="Welcome back" subtitle="Sign in to your command center">
      <Card className="border-border/60 shadow-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link
                  to="/forgot-password"
                  className="text-xs font-500 text-emerald transition-colors hover:text-emerald/80"
                >
                  Forgot password?
                </Link>
              </div>
        ...
        <CardFooter className="justify-center border-t border-border/40 py-4">
          <p className="text-sm text-muted-foreground">
            ...
            <Link to="/signup" className="font-500 text-emerald transition-colors hover:text-emerald/80">
              Sign up
            </Link>
          </p>
        </CardFooter>
